...
import { makeGoogleProtobufEmptyInput } from './google/protobuf/empty_pothos.js';
import { makeGoogleProtobufStructInput } from './google/protobuf/struct_pothos.js';
...
export function makeUserV1UserQueryInput(input: any): UserQuery {
  const message = create(UserQuerySchema, {
    /**
     * @generated from field: string search_term = 1;
     */
...
export function makeUserV1UserInput(input: any): User {
  const message = create(UserSchema, {
    /**
     * @generated from field: string id = 1;
     */
    id: input?.id,
...
export function makeUserV1User_AddressInput(input: any): User_Address {
  const message = create(User_AddressSchema, {
    /**
     * @generated from field: string street = 1;
     */
    street: input?.street,
