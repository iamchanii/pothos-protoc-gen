 ...
 * @generated from field: map<string, user.v1.Group> groups = 11;
 */
export const UserV1Group_GroupsMapEntryRef = builder
  .objectRef<{ key: string; value: Group }>('UserV1Group_GroupsMapEntry')
  .implement({
...
export const UserV1UserInputRef = builder
  ...
  .implement({
    ...
    fields: (t) => ({
       ...
       */
      groups: t.field({
        type: ['UserV1Group_GroupsMapEntryInput'],
        description: undefined,
        deprecationReason: undefined,
      }),
    }),
 ...
 * @generated from field: map<string, user.v1.Group> groups = 11;
 */
export const UserV1Group_GroupsMapEntryInputRef = builder
  .inputRef<{ key: string; value: Group }>('UserV1Group_GroupsMapEntryInput')
  .implement({
    description: 'Key-value pair for the map field groups of user.v1.Group.',
    fields: (t) => ({
