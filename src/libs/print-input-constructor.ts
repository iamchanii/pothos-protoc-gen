...
export function printInputConstructor(f: GeneratedFile, message: DescMessage) {
  ...
  f.print`${f.export('function', getInputConstructorName(message))}(input: any): ${importShapeFromProto(f, message)} {`;
  f.print`  return ${f.runtime.create}(${importSchemaFromProto(f, message)}, {`;
