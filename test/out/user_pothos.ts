...
export const UserV1UserRef = builder.objectRef<User>('UserV1User').implement({
  ...
  fields: (t) => ({
    ...
    groups: t.field({
      ...
      resolve: (parent) =>
        Object.entries(parent.groups).map(([key, value]) => ({
          key: String(key),
          value: value,
        })),
      description: undefined,
 ...
 */
export const UserV1GroupRef = builder
  .objectRef<Group>('UserV1Group')
  .implement({
    description: undefined,
    deprecationReason: undefined,
    fields: (t) => ({
 ...
 * @generated from field: map<string, user.v1.Group> groups = 11;
 */
export const String_UserV1GroupMapEntryRef = builder
  .objectRef<{ key: string; value: Group }>('String_UserV1GroupMapEntry')
  .implement({
 ...
 * @generated from message user.v1.Group
 */
export const UserV1GroupInputRef = builder
  .inputRef<Group>('UserV1GroupInput')
  .implement({
    description: undefined,
    deprecationReason: undefined,
    fields: (t) => ({
 ...
 * @generated from field: map<string, user.v1.Group> groups = 11;
 */
export const String_UserV1GroupMapEntryInputRef = builder
  .inputRef<{ key: string; value: Group }>('String_UserV1GroupMapEntryInput')
  .implement({
    description: 'Key-value pair for the map field groups of user.v1.Group.',
    fields: (t) => ({
...
export function makeUserV1UserInput(input: any): User {
  return create(UserSchema, {
    ...
    groups: input?.groups
      ? Object.fromEntries(
          input?.groups?.map(({ key, value }) => [
            key,
            makeUserV1GroupInput(value),
          ]),
        )
      : null,
  });
